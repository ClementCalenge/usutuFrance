...
%\VignetteDepends{knitr,lubridate,ggplot2,sf,viridis,splancs,stpp,spatstat.geom,spatstat.model,adehabitatHS,sp,ggspatial,MASS,terra,tidyterra,ggpubr,dplyr,tidyr,gratia}
\usepackage{fancyvrb}
\usepackage{color}
\usepackage{url}
\usepackage{amsfonts}
